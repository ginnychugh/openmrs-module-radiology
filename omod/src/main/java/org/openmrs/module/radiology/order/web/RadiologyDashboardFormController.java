...
public class RadiologyDashboardFormController {
    ...
    /**
     * Handles normal get requests to the radiology dashboard page.
     * @return model and view
     * @should return model and view
     */
     ...
     * 
     * @param request HttpServletRequest to import file
     * @param templateFile file being imported
