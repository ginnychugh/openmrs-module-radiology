...
public class MrrtReportTemplateValidatorTest {
	...
	public void validate_shouldThrowApiExceptionIfTemplateDoesNotHaveAnHtmlElement() throws Exception {
		...
		final File invalidTemplate = new File(getClass().getClassLoader().getResource("mrrttemplates/ihe/connectathon/2015/invalidMrrtReportTemplate-missingHtmlElement.html").getFile());
	...
	public void validate_shouldThrowApiExceptionIfTemplateHasMoreThanOneHtmlElement() throws Exception {
		expectedException.expect(APIException.class);
		final File invalidTemplate = new File(getClass().getClassLoader().getResource("mrrttemplates/ihe/connectathon/2015/invalidMrrtReportTemplate-multipleHtmlElements.html").getFile());
		validator.validate(invalidTemplate);
	}
	...
	public void validate_shouldThrowApiExceptionIfHtmlElementDoesNotHaveAHeadElement() throws Exception {
		expectedException.expect(APIException.class);
		final File invalidTemplate = new File(getClass().getClassLoader().getResource("mrrttemplates/ihe/connectathon/2015/invalidMrrtReportTemplate-noHeadElementFound.html").getFile());
		validator.validate(invalidTemplate);
	}
	...
	public void validate_shouldThrowApiExceptionIfHtmlElementHasMoreThanOneHeadElement() throws Exception {
		expectedException.expect(APIException.class);
		final File invalidTemplate = new File(getClass().getClassLoader().getResource("mrrttemplates/ihe/connectathon/2015/invalidMrrtReportTemplate-multipleHeadElements.html").getFile());
		validator.validate(invalidTemplate);
	}
	...
	public void validate_shouldThrowApiExceptionIfHeadElementDoesNotHaveATitleElement() throws Exception {
		expectedException.expect(APIException.class);
		final File invalidTemplate = new File(getClass().getClassLoader().getResource("mrrttemplates/ihe/connectathon/2015/invalidMrrtReportTemplate-noTitleElement.html").getFile());
		validator.validate(invalidTemplate);
	}
	...
	public void validate_shouldThrowApiExceptionIfHeadElementHasMoreThanOneTitleElement() throws Exception {
		expectedException.expect(APIException.class);
		final File invalidTemplate = new File(getClass().getClassLoader().getResource("mrrttemplates/ihe/connectathon/2015/invalidMrrtReportTemplate-multipleTitleElements.html").getFile());
		validator.validate(invalidTemplate);
	}
	 ...
	 */
	@Test
	public void validate_shouldThrowApiExceptionIfHeadElementDoesNotHaveAMetaElementWithCharsetAttribute()
			throws Exception {
		expectedException.expect(APIException.class);
		final File invalidTemplate = new File(getClass().getClassLoader().getResource("mrrttemplates/ihe/connectathon/2015/invalidMrrtReportTemplate-noMetaElementWithCharsetAttribute.html").getFile());
		validator.validate(invalidTemplate);
	}
	...
	public void validate_shouldThrowApiExceptionIfHeadElementHasMoreThanOneMetaElementWithCharsetAttribute()
			throws Exception {
		expectedException.expect(APIException.class);
		final File invalidTemplate = new File(getClass().getClassLoader().getResource("mrrttemplates/ihe/connectathon/2015/invalidMrrtReportTemplate-multipleMetaElementsWithCharsetAttribute.html").getFile());
		validator.validate(invalidTemplate);
	}
	...
	public void validate_shouldThrowApiExceptionIfHeadElementDoesNotHaveOneOrMoreMetaElementsDenotingDublinCoreAttributes()
			throws Exception {
		expectedException.expect(APIException.class);
		final File invalidTemplate = new File(getClass().getClassLoader().getResource("mrrttemplates/ihe/connectathon/2015/invalidMrrtReportTemplate-noMetaElementDenotingDublinCoreAttributes.html").getFile());
		validator.validate(invalidTemplate);
	}
	...
	public void validate_shouldThrowApiExceptionIfHeadElementDoesNotHaveScriptElement() throws Exception {
		expectedException.expect(APIException.class);
		final File invalidTemplate = new File(getClass().getClassLoader().getResource("mrrttemplates/ihe/connectathon/2015/invalidMrrtReportTemplate-noScriptElement.html").getFile());
		validator.validate(invalidTemplate);
	}
	...
	public void validate_shouldThrowApiExceptionIfHeadElementHasMoreThanOneScriptElement() throws Exception {
		expectedException.expect(APIException.class);
		final File invalidTemplate = new File(getClass().getClassLoader().getResource("mrrttemplates/ihe/connectathon/2015/invalidMrrtReportTemplate-multipleScriptElements.html").getFile());
		validator.validate(invalidTemplate);
	}
	 ...
	 */
	@Test
	public void validate_shouldThrowApiExceptionIfScriptElementDoesNotHaveATemplateAttributesElement()
			throws Exception {
		expectedException.expect(APIException.class);
		final File invalidTemplate = new File(getClass().getClassLoader().getResource("mrrttemplates/ihe/connectathon/2015/invalidMrrtReportTemplate-noTemplateAttributesElement.html").getFile());
		validator.validate(invalidTemplate);
	}
	 ...
	 */
	@Test
	public void validate_shouldThrowApiExceptionIfScriptElementHasMoreThanOneTemplateAttributesElement()
			throws Exception {
		expectedException.expect(APIException.class);
		final File invalidTemplate = new File(getClass().getClassLoader().getResource("mrrttemplates/ihe/connectathon/2015/invalidMrrtReportTemplate-multipleTemplateAttributesElement.html").getFile());
		validator.validate(invalidTemplate);
	}
	...
	public void validate_shouldThrowApiExceptionIfCodingSchemesElementDoesNotHaveAtLeastOneCodingSchemeElement()
			throws Exception {
		expectedException.expect(APIException.class);
		final File invalidTemplate = new File(getClass().getClassLoader().getResource("mrrttemplates/ihe/connectathon/2015/invalidMrrtReportTemplate-codingSchemesShouldHaveAtLeastOneCodingSchemeElement.html").getFile());
		validator.validate(invalidTemplate);
	}
	...
	public void validate_shouldThrowApiExceptionIfTermElementDoesNotHaveACodeElement() throws Exception {
		expectedException.expect(APIException.class);
		final File invalidTemplate = new File(getClass().getClassLoader().getResource("mrrttemplates/ihe/connectathon/2015/invalidMrrtReportTemplate-termElementShouldHaveOneCodeElement.html").getFile());
		validator.validate(invalidTemplate);
	}
	...
	public void validate_shouldThrowApiExceptionIfTermElementHasMoreThanOneCodeElement() throws Exception {
		expectedException.expect(APIException.class);
		final File invalidTemplate = new File(getClass().getClassLoader().getResource("mrrttemplates/ihe/connectathon/2015/invalidMrrtReportTemplate-multipleCodeElementsInTermElement.html").getFile());
		validator.validate(invalidTemplate);
	}
	 ...
	 */
	@Test
	public void validate_shouldThrowApiExceptionIfCodeElementLacksOneOfMeaningSchemeOrValueAttribute()
			throws Exception {
		expectedException.expect(APIException.class);
		final File invalidTemplate = new File(getClass().getClassLoader().getResource("mrrttemplates/ihe/connectathon/2015/invalidMrrtReportTemplate-missingAttributesInCodeElement.html").getFile());
		validator.validate(invalidTemplate);
	}
	...
	public void validate_shouldThrowApiExceptionIfTemplateAttributesElementHasMoreThanOneCodedContentElement()
			throws Exception {
		expectedException.expect(APIException.class);
		final File invalidTemplate = new File(getClass().getClassLoader().getResource("mrrttemplates/ihe/connectathon/2015/invalidMrrtReportTemplate-multipleCodedContent.html").getFile());
		validator.validate(invalidTemplate);
	}
	...
	public void validate_shouldThrowApiExceptionIfHtmlElementDoesNotHaveABodyElement() throws Exception {
		expectedException.expect(APIException.class);
		final File invalidTemplate = new File(getClass().getClassLoader().getResource("mrrttemplates/ihe/connectathon/2015/invalidMrrtReportTemplate-noBodyElement.html").getFile());
		validator.validate(invalidTemplate);
	}
	...
	public void validate_shouldThrowApiExceptionIfHtmlElementHasMoreThanOneBodyElement() throws Exception {
		expectedException.expect(APIException.class);
		final File invalidTemplate = new File(getClass().getClassLoader().getResource("mrrttemplates/ihe/connectathon/2015/invalidMrrtReportTemplate-multipleBodyElement.html").getFile());
		validator.validate(invalidTemplate);
	}
}
